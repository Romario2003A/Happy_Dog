...
api.interceptors.response.use(r=>r, e=>{ if([401,403].includes(e.response?.status)){ localStorage.removeItem('vet_token'); localStorage.removeItem('vet_user'); } return Promise.reject(e); });
